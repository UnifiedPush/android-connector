...
git clone --filter=blob:none https://codeberg.org/UnifiedPush/android-foss_embedded_fcm_distributor
ln -s android-foss_embedded_fcm_distributor/foss_embedded_fcm_distributor .

echo """
include ':connector_ui'
include ':embedded_fcm_distributor'
include ':foss_embedded_fcm_distributor'
""" >> settings.gradle
